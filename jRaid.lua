...
function jRaid:GetDefaults()
    return {
        CVars = {
            ...
            raidFramesDisplayAggroHighlight = GetCVar( 'raidFramesDisplayAggroHighlight' ) or 0,
    ...
    return {
        ...
        args = {
            ...
            raidFramesDisplayAggroHighlight = {
                ...
                desc = 'Whether to highlight a user\'s raid frames if they have aggro',
                arg = 'raidFramesDisplayAggroHighlight',
            },
